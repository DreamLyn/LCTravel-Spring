...
public interface TouristMapper {
    ...
    int getTouristCountWithName(@Param("travelId")int travelId,@Param("name")String name);
    /**
     * 更新同行状态
     * @param travelId
     * @param peer
    ...
    ArrayList<Tourist> getTouristsWithTravelIdWithoutFilter(@Param("travelId")int travelId);
    /**
     * 获取游客信息
     * @param travelId
     * @param peerList
